...
const S = {
  ...
  searchSelectInputWrap: {
    ...
    gap: "8px",
    padding: "8px 10px",
    borderBottom: `1px solid ${LICENSE_BORDER}`,
  } as React.CSSProperties,
  searchSelectInput: {
    flex: "1 1 auto",
    minWidth: 0,
...
function SearchIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path
        d="M19 19L14.657 14.657M16.778 8.889C16.778 13.246 13.246 16.778 8.889 16.778C4.531 16.778 1 13.246 1 8.889C1 4.531 4.531 1 8.889 1C13.246 1 16.778 4.531 16.778 8.889Z"
        stroke={PLACEHOLDER}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function SearchableSelect({
  ...
  return (
    <div style={S.selectWrap} ref={wrapRef}>
      <button
        type="button"
        id={id}
        className="nb-select"
      ...
      {isOpen && (
        <div style={S.searchSelectPanel}>
          <div style={S.searchSelectInputWrap}>
            <SearchIcon />
            <input
              ref={inputRef}
              type="text"
