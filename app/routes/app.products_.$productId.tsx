...
function InfoIcon() {
  return (
    <svg
      width="16"
      height="16"
      viewBox="741 181 16 16"
      fill="none"
      aria-hidden="true"
      style={{ flexShrink: 0, display: "block" }}
    >
      <path
        d="M750 192.5L749.5 192.5V188.031C749.5 188.026 749.498 188.021 749.498 188.016C749.498 188.01 749.5 188.005 749.5 188C749.5 187.724 749.276 187.5 749 187.5H748C747.724 187.5 747.5 187.724 747.5 188C747.5 188.276 747.724 188.5 748 188.5H748.5V192.5H748C747.724 192.5 747.5 192.724 747.5 193C747.5 193.276 747.724 193.5 748 193.5H750C750.276 193.5 750.5 193.276 750.5 193C750.5 192.724 750.276 192.5 750 192.5ZM749 186.5C749.552 186.5 750 186.052 750 185.5C750 184.948 749.552 184.5 749 184.5C748.448 184.5 748 184.948 748 185.5C748 186.052 748.448 186.5 749 186.5ZM749 181C744.582 181 741 184.582 741 189C741 193.418 744.582 197 749 197C753.418 197 757 193.418 757 189C757 184.582 753.418 181 749 181ZM749 196.016C745.14 196.016 742 192.86 742 189C742 185.14 745.14 182 749 182C752.86 182 756 185.14 756 189C756 192.86 752.86 196.016 749 196.016Z"
        fill={BLUE}
      />
    </svg>
  );
